...
class Sudoku:
    ...
    def eliminate(self, cell, value):
        ...
        if len(possibilities) == 0:
            raise Contradiction('No possibilities left for {} after eliminating {}!'.format(cell, value))
        elif len(possibilities) == 1:
            new_value = list(possibilities)[0]
            if self._verbose:
                print('Only possibility is {} for {}, pruning it from peers!'.format(new_value, cell))
